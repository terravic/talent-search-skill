...
| 2 | `Full Name` | Yes | String | Candidate's complete professional name with standard credentials (e.g., "Jane Doe, FSA, MAAA" or "Alex Smith, MD, MS"). |
...
2. **Link Formatting:**
   - Always format URLs as clickable Markdown links with descriptive source names:
     - `[Apex Health Leadership](https://example.com/leadership)`
